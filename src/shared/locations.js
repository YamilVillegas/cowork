export const LOCATIONS = [
    {
        ...
        rooms: 100,
        description: "Premium offices located in the heart of the world's economy.",
        comments: [
            {
                id: 0,
                rating: 5, 
    ...
    },
    {
        ...
        rooms: 75,
        description: "Beautiful spacious offices located in the heart of Chicago.",
        comments: [
            {
                id: 0,
                rating: 5, 
    ...
    },
    {
        ...
        rooms: 100,
        description: "Come see our amazing views in our co-working enviornment out in California",
        comments: [
            {
                id: 0,
                rating: 5, 
    ...
    },
    {
        ...
        rooms: 75,
        description: "You'll never want to leave this cool comfortable office space with Palm Trees decorating our sidewalks.",
        comments: [
            {
                id: 0,
                rating: 5, 
